...
teams[1] = {name = "Team 1", color = Vector( 1.0, .2, .2 ), weapons = {"weapon_crowbar", "weapon_crossbow"} } //Add weapons here, teams can be viewed in shared.lua
teams[2] = {name = "Team 2", color = Vector( .2, 1.0, .2 ), weapons = {"weapon_crowbar", "weapon_crossbow"} }
