...
team_1:SetPos( 10, 0 ) --Place it half way on the tall and 5 units in horizontal
...
team_2:SetPos( 110, 0 ) --Place it next to our previous one
...
team_3:SetPos( 210, 0 ) --Place it next to our previous one
