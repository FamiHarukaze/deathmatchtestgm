...
teams[2] = {name = "Team 1", color = Vector( 1.0, .2, .2 ), weapons = {"weapon_crowbar", "weapon_rpg"} }
teams[3] = {name = "Team 2", color = Vector( .2, 1.0, .2 ), weapons = {"weapon_crowbar", "weapon_rpg"} }
teams[4] = {name = "Team 3", color = Vector( .2, .2, 1.0 ), weapons = {"weapon_crowbar", "weapon_rpg"} }
...
function ply:GiveGamemodeWeapons()
	...
	self:SetAmmo( 500, "RPG_Round", true )
